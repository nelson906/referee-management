<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Calendario Tornei - visibile a tutti --}}
                    ...
                    <x-nav-link :href="route('admin.tournaments.admin-index')" :active="request()->routeIs('admin.tournaments.*')">
                        <svg class="w-4 h-4 mr-1 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(auth()->user() && (auth()->user()->hasRole('Admin') || auth()->user()->hasRole('SuperAdmin') || auth()->user()->hasRole('NationalAdmin')))
            <x-responsive-nav-link :href="route('admin.tournaments.admin-index')" :active="request()->routeIs('admin.tournaments.*')">
                Gestione Tornei
            </x-responsive-nav-link>
            @endif
        </div>
