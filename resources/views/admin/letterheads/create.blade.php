...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">Nuova Letterhead</h1>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.letterheads.store') }}" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('header_text') is-invalid @enderror"
                                      id="header_text"
                                      name="header_text"
                                      rows="3">{{ old('header_text') }}</textarea>
                            @error('header_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('footer_text') is-invalid @enderror"
                                      id="footer_text"
                                      name="footer_text"
                                      rows="3">{{ old('footer_text') }}</textarea>
                            @error('footer_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select form-select-sm"
                                ...
                                <option value="Courier" {{ old('settings.font.family') === 'Courier' ? 'selected' : '' }}>Courier</option>
                            </select>
                        </div>
                        <div class="row">
                            <div class="col-6">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.letterheads.index') }}" class="btn btn-secondary">
                        <i class="fas fa-times"></i> Annulla
                    </a>
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Salva Letterhead
                    </button>
                </div>
            </div>
        </div>
