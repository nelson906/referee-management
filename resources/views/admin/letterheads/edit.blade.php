        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
                    ...
                    <a href="{{ route('admin.letterheads.show', $letterhead) }}" class="hover:text-gray-700">{{ Str::limit($letterhead->title, 30) }}</a>
                    <span class="mx-2">/</span>
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('admin.letterheads.show', $letterhead) }}" class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.letterheads.update', $letterhead) }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Scegli file --}}
                        <div>
                            <label for="logo" class="block text-sm font-medium text-gray-700 mb-1">Scegli file</label>
                            ...
                            <p class="mt-1 text-xs text-gray-500">JPG, PNG, SVG fino a 2MB. {{ $letterhead->logo_path ? 'Lascia vuoto per mantenere il logo attuale.' : '' }}</p>
                            @error('logo')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @if($letterhead->logo_path)
                                <div class="mb-4 flex items-center space-x-4">
                                    <img src="{{ $letterhead->logo_url }}" alt="Logo attuale" class="h-16 w-auto object-contain border rounded">
                                    <div>
                                        <p class="text-sm text-gray-600">Logo attuale: {{ basename($letterhead->logo_path) }}</p>
                                        <button type="button" onclick="removeLogo()" class="text-sm text-red-600 hover:text-red-800">Rimuovi logo</button>
                                    </div>
                                </div>
                            @endif
            ...
            <div class="flex justify-between pt-6 border-t">
                <a href="{{ route('admin.letterheads.show', $letterhead) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="removeLogoModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
