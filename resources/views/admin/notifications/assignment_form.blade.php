                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h4 class="text-md font-medium text-gray-900 mb-4">
                                👥 Arbitri Assegnati ({{ $assignments->count() }})
                            </h4>
                            ...
                            @else
                                <p class="text-sm text-gray-600">⚠️ Nessun arbitro assegnato</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form method="POST" action="{{ route('tournaments.send-assignment', $tournament) }}" class="space-y-8">
                                @csrf
