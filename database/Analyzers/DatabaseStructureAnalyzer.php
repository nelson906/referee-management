...
/**
 * ========================================
 * ANALIZZATORE STRUTTURA DATABASE
 * ========================================
 * Script per analizzare la struttura del database gestione_arbitri
 * e validare il mapping roles/permissions
 */

namespace Database\Analyzers;
...
class DatabaseStructureAnalyzer
{
    ...
    /**
     * ✅ Analisi completa del database gestione_arbitri
     */
    public function analyzeSourceDatabase(): array
    {
        $this->info('🔍 ANALISI STRUTTURA DATABASE gestione_arbitri');
        $this->info('=====================================');
...
/**
 * ========================================
 * COMANDO ARTISAN PER ANALISI
 * ========================================
 * Crea questo file: app/Console/Commands/AnalyzeDatabaseCommand.php
 */

namespace App\Console\Commands;

use Illuminate\Console\Command;
use Database\Analyzers\DatabaseStructureAnalyzer;
...
class AnalyzeDatabaseCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $analyzer = new DatabaseStructureAnalyzer($this);
        $analysis = $analyzer->analyzeSourceDatabase();
