...
/**
 * ========================================
 * ClubsSeeder.php - VERSIONE CORRETTA
 * ========================================
 * Rinominato da ClubSeeder a ClubsSeeder per coerenza
 * Aggiornato per funzionare con il sistema esistente
 */
class ClubsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Verifica che le zone esistano
        $zones = Zone::orderBy('code')->get();
        if ($zones->isEmpty()) {
            $this->command->error('❌ Nessuna zona trovata. Esegui prima ZonesSeeder.');
            return;
        }
    ...
    private function generatePostalCode(string $province): string
    {
        $postalCodes = [
            'TO' => '10' . rand(100, 199),
            'AO' => '11' . sprintf('%03d', rand(0, 99)),
            'MI' => '20' . rand(100, 199),
            'MB' => '20' . rand(800, 900),
            'BG' => '24' . sprintf('%03d', rand(0, 199)),
            'BS' => '25' . sprintf('%03d', rand(0, 199)),
            'VE' => '30' . rand(100, 199),
            'VR' => '37' . sprintf('%03d', rand(0, 199)),
            'PD' => '35' . sprintf('%03d', rand(0, 199)),
            'TN' => '38' . sprintf('%03d', rand(0, 199)),
            'BO' => '40' . rand(100, 199),
            'MO' => '41' . sprintf('%03d', rand(0, 199)),
            'RN' => '47' . rand(800, 900),
            'AN' => '60' . rand(100, 199),
            'FI' => '50' . rand(100, 199),
            'PI' => '56' . sprintf('%03d', rand(0, 199)),
            'GR' => '58' . sprintf('%03d', rand(0, 199)),
            'PG' => '06' . sprintf('%03d', rand(0, 199)),
            'RM' => '00' . rand(100, 199),
            'NA' => '80' . rand(100, 199),
            'BA' => '70' . sprintf('%03d', rand(0, 199)),
            'AG' => '92' . sprintf('%03d', rand(0, 199)),
            'CA' => '09' . sprintf('%03d', rand(0, 199)),
        ];
